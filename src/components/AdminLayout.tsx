        ...
        {showNavigation && (
          <div>
            <nav class="fixed inset-x-4 bottom-4 z-50 flex items-center gap-1 rounded-[1.65rem] border border-white/10 bg-slate-900/90 p-2 shadow-2xl shadow-black/30 backdrop-blur-2xl md:hidden" style="padding-bottom: calc(0.5rem + env(safe-area-inset-bottom));">
              ...
              <a href="/admin/activities" class={mobileNavItem(isJejak)} aria-current={isJejak ? 'page' : undefined}>
              ...
              <a href="/admin/inbox" class={mobileNavItem(currentPath.startsWith('/admin/inbox'))} aria-current={currentPath.startsWith('/admin/inbox') ? 'page' : undefined}>
                <span class="relative">
              ...
              <a href="/" class={mobileNavItem(false)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 3h7v7"/><path d="M10 14 21 3"/><path d="M21 14v5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5"/></svg>
                View Site
              </a>
            </nav>
